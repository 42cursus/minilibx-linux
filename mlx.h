...
void	*mlx_new_window(t_xvar *mlx_ptr, int size_x, int size_y, char *title);
/*
**  return void *0 if failed
*/
...
*/
int	mlx_put_image_to_window(t_xvar *mlx_ptr, t_win_list *win_ptr, t_img *img_ptr,
				int x, int y);
...
t_img	*mlx_xpm_to_image(t_xvar *xvar,
						  char **xpm_data, int *width, int *height);
t_img	*mlx_xpm_file_to_image(t_xvar *xvar,
